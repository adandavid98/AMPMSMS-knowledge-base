document.addEventListener('DOMContentLoaded', () => {
    ...
    const cerebrasKeyInput = document.getElementById('cerebrasKeyInput');
    ...
    const toggleCerebrasKey = document.getElementById('toggleCerebrasKey');
    ...
    if (toggleCerebrasKey) {
        toggleCerebrasKey.addEventListener('click', () => {
            cerebrasKeyInput.type = cerebrasKeyInput.type === 'password' ? 'text' : 'password';
        });
    }
    if (toggleGroqKey) {
    ...
    if (saveKeysBtn) {
        saveKeysBtn.addEventListener('click', () => {
            ...
            const cerebrasVal = cerebrasKeyInput ? cerebrasKeyInput.value.trim() : '';
            ...
            if (cerebrasVal) localStorage.setItem('cerebras_api_key', cerebrasVal);
    ...
    function loadSavedApiKeys() {
        ...
        if (savedCerebras && cerebrasKeyInput) cerebrasKeyInput.value = savedCerebras;
    ...
    function updateKeyBadgeStatus() {
        ...
        const hasCerebras = !!localStorage.getItem('cerebras_api_key');
        ...
        if (hasGemini || hasCerebras || hasGroq || hasOpenrouter || hasTavily) {
    ...
    chatForm.addEventListener('submit', async (e) => {
        ...
        if (savedCerebras) headers['X-Cerebras-Api-Key'] = savedCerebras;
